...
function load() {
    ...
    products.push(new product_1.Product(2, "Dell Inspiron", 60000, "Laptops"));
    products.push(new product_1.Product(3, "Xbox One", 35000, "Gaming"));
    products.push(new product_1.Product(4, "Lenovo Thinkpad", 88000, "Laptops"));
    products.push(new product_1.Product(5, "Logitech headphone 390", 4500, "Headphones"));
    products.push(new product_1.Product(6, "Amazon Echo", 7000, "Devices"));
    products.push(new product_1.Product(7, "HP Deskjet Printer", 15000, "Printers"));
    customers = new Array();
